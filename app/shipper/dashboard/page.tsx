  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-blue-900 to-purple-900">
      ...
      <header className="bg-white/10 backdrop-blur-md border border-white/20-b border-white/20 sticky top-0 z-40">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex justify-between items-center">
            <div>
              <h1 className="text-2xl font-bold text-white">Shipper Dashboard</h1>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid md:grid-cols-4 gap-6 mb-8">
          <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-xl shadow-sm border border-white/20 p-6">
            <div className="flex items-center justify-between mb-4">
              ...
              <span className="text-2xl font-bold text-white">{analytics?.activeShipments || 0}</span>
            </div>
            <div className="text-sm font-semibold text-gray-200">Active Shipments</div>
            <div className="text-xs text-gray-400 mt-1">Currently in transit</div>
          </div>
          ...
          <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-xl shadow-sm border border-white/20 p-6">
            <div className="flex items-center justify-between mb-4">
              ...
              <span className="text-2xl font-bold text-white">{analytics?.onTimeDeliveryRate || 0}%</span>
            </div>
            <div className="text-sm font-semibold text-gray-200">On-Time Rate</div>
          ...
          <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-xl shadow-sm border border-white/20 p-6">
            <div className="flex items-center justify-between mb-4">
              ...
              <span className="text-2xl font-bold text-white">{analytics?.averageDeliveryTime || 0}m</span>
            </div>
            <div className="text-sm font-semibold text-gray-200">Avg Delivery Time</div>
            <div className="text-xs text-gray-400 mt-1">Minutes per shipment</div>
          </div>
          ...
          <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-xl shadow-sm border border-white/20 p-6">
            <div className="flex items-center justify-between mb-4">
              ...
              <span className="text-2xl font-bold text-white">{analytics?.temperatureComplianceRate || 0}%</span>
            </div>
            <div className="text-sm font-semibold text-gray-200">Temp Compliance</div>
            <div className="text-xs text-gray-400 mt-1">Within range</div>
          </div>
        </div>

        {/* Active Shipments */}
        <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-xl shadow-sm border border-white/20 mb-8">
          <div className="p-6 border-b border-white/20">
            <h2 className="text-xl font-bold text-white">Active Shipments</h2>
            <p className="text-sm text-gray-300 mt-1">Track your in-transit deliveries</p>
          </div>
          <div className="divide-y divide-gray-200">
            {activeShipments.length === 0 ? (
              ...
              activeShipments.map(shipment => (
                <div key={shipment.id} className="p-6 hover:bg-gradient-to-br from-gray-900 via-blue-900 to-purple-900 transition-colors">
                      ...
                      <div className="grid md:grid-cols-2 gap-4 mb-3">
                        <div>
                          ...
                          <div className="flex items-start space-x-2">
                            ...
                            <div className="text-sm text-white">{shipment.pickup.address}</div>
                          </div>
                        </div>
                        <div>
                          ...
                          <div className="flex items-start space-x-2">
                            ...
                            <div className="text-sm text-white">{shipment.dropoff.address}</div>
                          </div>
                        </div>
                      </div>
        ...
        {/* Pending Shipments */}
        <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-xl shadow-sm border border-white/20">
          <div className="p-6 border-b border-white/20">
            <h2 className="text-xl font-bold text-white">Pending Shipments</h2>
            <p className="text-sm text-gray-300 mt-1">Awaiting driver assignment</p>
          </div>
          <div className="divide-y divide-gray-200">
