    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <header className="bg-white border-b border-gray-200">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          ...
          <p className="text-sm text-gray-600">AI-powered shipment creation workflow</p>
        </div>
      </header>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-8">
          ...
          {step === 2 && (
            <div className="space-y-6">
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <div>
                  <label className="block text-sm font-semibold text-gray-700 mb-2">Specimen Type</label>
                  <select
                ...
                <div>
                  <label className="block text-sm font-semibold text-gray-700 mb-2">Study Protocol</label>
                  <input
                    type="text"
              ...
              <div className="border-t border-gray-200 pt-6">
                ...
                <div className="grid md:grid-cols-3 gap-4">
                  ...
                  <div>
                    <label className="block text-sm font-semibold text-gray-700 mb-2">Min Temp (°C)</label>
                    <input
                      type="number"
                  ...
                  <div>
                    <label className="block text-sm font-semibold text-gray-700 mb-2">Max Temp (°C)</label>
                    <input
                      type="number"
              ...
              <div>
                ...
                <div className="grid md:grid-cols-3 gap-4">
                  {[
                    ...
                    >
                      <div className="font-semibold text-gray-900 mb-1">{priority.label}</div>
          ...
          {step === 4 && (
            <div className="space-y-6">
              <div className="text-center mb-6">
                ...
                <h2 className="text-xl font-bold text-gray-900">Best Matched Drivers</h2>
                <p className="text-sm text-gray-600 mt-1">Our AI has analyzed and ranked drivers based on your requirements</p>
              </div>
                  ...
                  >
                    <div className="flex items-start justify-between mb-4">
                      <div className="flex items-center space-x-4">
                        ...
                        <div>
                          <div className="font-bold text-gray-900 text-lg">{match.driverName}</div>
                          <div className="text-sm text-gray-600">{match.distance.toFixed(1)} miles away</div>
                        </div>
                      </div>
          ...
          {step === 5 && (
            <div className="space-y-6">
              <h2 className="text-xl font-bold text-gray-900 mb-4">Review Your Shipment</h2>
                ...
                <div className="space-y-2">
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-gray-700">{formData.pickupAddress}</div>
                    </div>
                  </div>
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-gray-700">{formData.dropoffAddress}</div>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="bg-gray-50 rounded-lg p-4">
                  <h3 className="font-bold text-gray-900 mb-3">Specimen Details</h3>
                  <div className="space-y-2 text-sm">
                    <div className="flex justify-between">
                      <span className="text-gray-600">Type:</span>
                      <span className="font-semibold text-gray-900">{formData.specimenType}</span>
                    </div>
                    <div className="flex justify-between">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="font-semibold text-gray-900">{formData.temperatureRequirement}</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-gray-50 rounded-lg p-4">
                  ...
                  <div className="space-y-2 text-sm">
                    <div className="flex justify-between">
                      ...
                      <span className="font-semibold text-gray-900">{formData.scheduledPickupDate}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-gray-600">Time:</span>
                      <span className="font-semibold text-gray-900">{formData.scheduledPickupTime}</span>
                    </div>
                    <div className="flex justify-between">
