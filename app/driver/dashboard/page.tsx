      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid md:grid-cols-4 gap-6 mb-8">
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            <div className="flex items-center justify-between mb-4">
              ...
              <span className="text-2xl font-bold text-gray-900">${earnings.today.toFixed(2)}</span>
            </div>
            <div className="text-sm font-semibold text-gray-700">Today's Earnings</div>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            ...
            <div className="text-sm font-semibold text-gray-700">Total Deliveries</div>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            ...
            <div className="text-xs text-gray-500 mt-1">Based on 342 reviews</div>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            <div className="flex items-center justify-between mb-4">
              ...
              <span className="text-2xl font-bold text-gray-900">${earnings.week.toFixed(0)}</span>
            </div>
        ...
        {activeDelivery ? (
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-12 mb-8 text-center">
            ...
            <p className="text-gray-600 mb-6">Browse available deliveries to start earning</p>
            <Link href="/driver/available">
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-8">
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            <h3 className="text-lg font-bold text-gray-900 mb-4">Your Certifications</h3>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            ...
            <div className="space-y-3">
              <div className="flex justify-between">
                ...
                <span className="font-semibold text-gray-900">{user.vehicleInfo?.type}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-gray-600">License Plate:</span>
                <span className="font-semibold text-gray-900">{user.vehicleInfo?.licensePlate}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-gray-600">Capacity:</span>
                <span className="font-semibold text-gray-900">{user.vehicleInfo?.capacity}</span>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
              <div>
                ...
                <div className="text-sm text-gray-600">3 deliveries completed</div>
              </div>
            ...
            <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
              <div>
                ...
                <div className="text-sm text-gray-600">18 deliveries completed</div>
              </div>
            ...
            <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
              <div>
                ...
                <div className="text-sm text-gray-600">76 deliveries completed</div>
              </div>
