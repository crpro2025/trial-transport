    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-blue-900 to-purple-900">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          ...
          <p className="text-gray-300 mt-2">Manage your administrator account settings</p>
        </div>

        <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-lg shadow-sm border border-white/20 p-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="md:col-span-2">
                ...
                <input
                  ...
                  value={formData.role}
                  disabled
                  className="w-full px-4 py-2 border border-white/30 rounded-lg bg-gradient-to-br from-gray-900 via-blue-900 to-purple-900 text-gray-400"
                />
