        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-20">
            ...
            <div className="hidden md:flex items-center gap-8">
              ...
              <Link href="#traction" className="text-gray-300 hover:text-white transition-colors">Traction</Link>
              <Link href="/login" className="text-gray-300 hover:text-white transition-colors">Login</Link>
              <Link
                href="/register"
                className="px-6 py-2 bg-gradient-to-r from-blue-600 to-cyan-600 rounded-lg hover:shadow-lg hover:shadow-blue-500/50 transition-all font-medium"
              >
                Get Started
              </Link>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
              ...
              <div>
                ...
                <ul className="space-y-2">
                  ...
                  <li className="flex items-start gap-2 text-gray-300 text-sm">
                    <span className="text-green-400 mt-1">✓</span>
                    <span>FDA/HIPAA compliance certification</span>
                  </li>
                  <li className="flex items-start gap-2 text-gray-300 text-sm">
                    <span className="text-green-400 mt-1">✓</span>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div>
                ...
                <ul className="space-y-2 text-gray-300 text-sm">
                  ...
                  <li className="flex items-start gap-2">
                    <span className="text-blue-400 mt-1">•</span>
                    <span>FDA/HIPAA compliance: 6 months</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-blue-400 mt-1">•</span>
