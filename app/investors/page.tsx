...
export default function InvestorsPage() {
  ...
  const highlights = [
    ...
    },
    {
      ...
      description: '68% margins, 10x LTV/CAC, 2.4-month payback',
    },
    {
      icon: '🚀',
              ...
              <table className="w-full text-left">
                ...
                <tbody className="text-white">
                  <tr className="border-b border-white/5">
                    ...
                    <td className="py-4">$329K</td>
                    <td className="py-4 text-red-400">$74K</td>
                  ...
                  <tr className="border-b border-white/5">
                    ...
                    <td className="py-4">$13.2M</td>
                    <td className="py-4 text-green-400">$6.5M</td>
                    <td className="py-4">2,000</td>
                    <td className="py-4 text-green-400">132%</td>
                  </tr>
                  <tr>
                    <td className="py-4 font-semibold">2030</td>
                    <td className="py-4">$26.3M</td>
                    <td className="py-4 text-green-400">$13.4M</td>
